...
export function SmallDashboardCard({ delay = 1, className, title, content, type = 'skeleton', children, onClick }: SmallDashboardCardProps) {
  return (
    <Flex
      background="surface"
      border="neutral-weak"
    ...
    >
      {children ? (
        ...
        <Flex direction="column" gap="s" style={{ flex: 1, justifyContent: 'flex-start', alignItems: 'flex-start', overflow: 'auto', scrollbarWidth: 'thin' }}>
